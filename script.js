document.addEventListener('DOMContentLoaded', () => {
    ...
    const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbwkmo2oqqgQmG7JrrK_Nc2rtk8uHaASJLpwvxVmUVf6s00n6cx4DaUZPa97j4Oj6nKQ/exec';
    ...
    const addRecordToDOM = (record) => {
        ...
        const typeText = { 'drama': '드라마', 'documentary': '다큐멘터리', 'SF': 'SF', 'action': '액션' };
